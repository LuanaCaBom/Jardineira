        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo dateConvert($dados['DataHora']); ?></td>
                    <td><?php echo $dados['Nome']; ?></td>
                    <td><?php echo dateConvert($dados['DataHora']); ?></td>
                    <td>
                        <a class="btn btn-primary" href="../Pedido/formAddPedido.php?Id=<?php echo $dados['Id']; ?>">Adicionar Produto</a>
                        <a class="btn btn-secondary" href="../Pedido/exibirPedido.php?Id=<?php echo $dados['Id']; ?>">Ver Produtos</a>
                        <a class="btn btn-info" href="formEditCompra.php?Id=<?php echo $dados['Id']; ?>">Editar</a>
                        <a class="btn btn-danger" href="deletePedido.php?Id=<?php echo $dados['Id']; ?>" onclick="return confirm('Tem certeza de que deseja remover?');">Remover</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
